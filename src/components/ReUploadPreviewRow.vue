  ...
  <div class="re-upload-preview">
    <div class="re-upload-preview__content">
      <div class="preview-row">
        ...
        <!-- <div class="preview-row__image" :style="`background-image: url(${snapImage || attachment.file});`" /> -->
        <!-- v-if="$attrs.preview.image" -->
        <p class="preview-row__info">
...
import ReUploadPreviewVideoModalContent from '@/components/ReUploadPreviewVideoModalContent.vue';
